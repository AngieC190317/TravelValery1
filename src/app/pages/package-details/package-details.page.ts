...
export class PackageDetailsPage implements OnInit {
  package: any;
  packages = [
    { id: 1, name: 'San Andrés', description: 'Incluye tiquetes y hospedaje', image: 'assets/san-andres.jpg' },
    { id: 2, name: 'Cartagena', description: 'Disfruta de la ciudad amurallada', image: 'assets/cartagena.jpg' },
  ];
